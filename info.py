...
API_ID = int(environ.get('API_ID', '1330920'))
API_HASH = environ.get('API_HASH', '56d39dc81227478a6ea0061b26f71cf4')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '966092421').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001695244530').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://<username>:<password>@zorox.u8fbufy.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Zoroxtobot")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001695244530'))
